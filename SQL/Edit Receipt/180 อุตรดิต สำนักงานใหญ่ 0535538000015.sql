Declare @RefNo varchar(50) = '18502/APP/000558-511' ---17502/APP/000109-511,18502/APP/000178-511
...
select 
	...
	a.[Type_Id],
	a.Party_Id,
	c.Id as [PartyClassificationTH_Id],
	d.Id as [PartyClassificationEN_Id],
	b.Id as [OrganizationName_Id],
	f.Id as [CompanyRegistration_Id],
	g.ContactMechanism_Id as [ContactMechanism_Id]
	,ag.Discriminator
From PartyRole a 
inner join Agreement ag on (ag.InsuranceApplication_Id = a.InsuranceApplication_Id)
inner join InsuranceApplicationRoleItem iar on (iar.InsuranceApplicationRole_Id = a.Id)
left join OrganizationName b on (a.Party_Id = b.Organization_Id and b.ThruDate is NULL)
left join PartyClassification c on (a.Party_Id = c.Party_Id and c.SequencePartyType = 1 and c.Party_Id is not null)
left join PartyClassification d on (a.Party_Id = d.Party_Id and d.SequencePartyType = 2 and d.Party_Id is not null)
left join CompanyRegistration f on (a.Party_Id = f.Organization_Id and f.[Type_Id] = 'F8E30A8A-00DE-4A77-AD47-10CF35F923F4' and f.ThruDate is null) --�Ţ�����������
left join InsuranceApplicationRoleContactMechanism g on (a.Id = g.InsuranceApplicationRole_Id  and g.ShowOnPolicy = 1 and (g.ContactMechanismPurposeType_Id = '636B3BA8-9158-4AEE-A669-5B2F2D7DC5BB' or g.ContactMechanismPurposeType_Id = 'E3A26D7E-94C2-439F-9B8A-A644078304B2')) --�Ѵ�������/㺡ӡѺ����
left join DependencyContextItem j on (j.DependencyContextId = a.InsuranceApplication_Id and (f.Id = j.DependencyContextItemId))
where ag.ReferenceNumber = '18502/APP/000518-511'
and iar.IsPayment = 1

BEGIN TRAN
	UPDATE c 
	SET [Type_Id] = '1E283A60-C34A-4CE5-AA05-BA79F89B7174',
	Party_Id = '8C5B3FB7-EB54-4F5F-A7E9-C5E81B2D5E55',
	PartyClassificationTH_Id = 'B8298F27-5CD6-4681-823F-FA208AF49519',
	PartyClassificationEN_Id = '9AE7B151-EE43-4382-A160-E6BE4617638F',
	OrganizationName_Id = '9ABC6FCD-3EC4-4C49-954B-15DB6BC8652A',
	CompanyRegistration_Id = '28E3D650-C760-4180-A8EB-D29666EE66F3',
	ContactMechanism_Id = 'CDED1B0C-4AE1-4AE9-95A7-EFBC940AD4FB'
	--select c.*
	from PartyRole a
	inner join Agreement b on (a.InsuranceApplication_Id = b.InsuranceApplication_Id)
	inner join PaymentRole c on (a.Id = c.PartyRole_Id)
	where b.Discriminator = 'FileImportApplicant'
	and a.Party_Id = '8C5B3FB7-EB54-4F5F-A7E9-C5E81B2D5E55'
	and b.ReferenceNumber in 
	(
	'18502/APP/000518-511',
	'18502/APP/000519-511',
'18502/APP/000520-511',
'18502/APP/000521-511',
'18502/APP/000522-511',
'18502/APP/000523-511',
'18502/APP/000524-511',
'18502/APP/000525-511',
'18502/APP/000526-511',
'18502/APP/000527-511',
'18502/APP/000528-511',
'18502/APP/000529-511',
'18502/APP/000530-511',
'18502/APP/000531-511',
'18502/APP/000532-511',
'18502/APP/000533-511',
'18502/APP/000534-511',
'18502/APP/000535-511',
'18502/APP/000536-511',
'18502/APP/000537-511',
'18502/APP/000538-511',
'18502/APP/000539-511',
'18502/APP/000540-511',
'18502/APP/000541-511',
'18502/APP/000542-511',
'18502/APP/000543-511',
'18502/APP/000544-511',
'18502/APP/000545-511',
'18502/APP/000546-511',
'18502/APP/000547-511',
'18502/APP/000548-511',
'18502/APP/000549-511',
'18502/APP/000550-511',
'18502/APP/000551-511',
'18502/APP/000552-511',
'18502/APP/000553-511',
'18502/APP/000554-511',
'18502/APP/000555-511',
'18502/APP/000556-511',
'18502/APP/000557-511',
'18502/APP/000558-511'
	)
...
left join InsuranceApplicationRoleContactMechanism g on (a.Id = g.InsuranceApplicationRole_Id  and g.ShowOnPolicy = 1 and (g.ContactMechanismPurposeType_Id = '636B3BA8-9158-4AEE-A669-5B2F2D7DC5BB' or g.ContactMechanismPurposeType_Id = 'E3A26D7E-94C2-439F-9B8A-A644078304B2')) --�Ѵ�������/㺡ӡѺ����
left join DependencyContextItem j on (j.DependencyContextId = a.InsuranceApplication_Id and (f.Id = j.DependencyContextItemId))
where a.Id = '0DC14453-FFFE-4BB0-8EE0-596033FDC9B8'



select * from OrganizationName where Organization_Id = 'A66B6287-0F0F-4A5E-9A3A-ECE4656D63DB'

select d.ReferenceNumber, g.NameTH, h.RegistrationNumber, i.Address1, f.PartyRole_Id
	from Agreement a
	left join PremiumSchedule b on (a.InsuranceApplication_Id = b.InsuranceApplication_Id)
	left join PaymentApplication c on (b.Id = c.PremiumSchedule_Id)
	left join Payment d on (c.Payment_Id = d.Id)
	...
	inner join CompanyRegistration h on (f.CompanyRegistration_Id = h.Id and g.ThruDate is null )
	inner join ContactMechanism i on (f.ContactMechanism_Id = i.Id)
	where a.ReferenceNumber = '18502/APP/000519-511'
